...
//        fail("Delete this fail() and FIX the the line below.");
...
//        fail("Delete this fail() and FIX the assertion below.");
        //-----------------------------------------
         assertTrue("Instant should have nanoseconds", java8Instant.getNano() > 0);
    }
    ...
    public void instantStringFormatting() {
        ...
        // REPLACE the FIX_WITH_RIGHT_CALL below with a method call on Instant.
        assertEquals("Instant toString() should match ISO8601 format", classicDateFormatter.format(classicDate), java8Instant.toString());
    }
