...
public class Exercise2Test {
    ...
    public void simpleAssignmentOfLocalDate1() {
        ...
        //-----------------------------------------
         LocalDate stPatricksDay2015 = LocalDate.of(2015, 03,17); // Fix to take year, month and date
//        fail("Delete this fail() and FIX the assertion line below.");
    ...
    public void simpleAssignmentOfLocalDate2() {
        ...
        //-----------------------------------------
         LocalDate halsBirthday = LocalDate.of(1999, Month.JANUARY, 12); // Fix to take year, Month and date
//        fail("Delete this fail() and FIX the assertion line below.");
    ...
    public void recommendedDateBasedTestingForLocalDate() {
        ...
        //-----------------------------------------
         LocalDate tOJDDate = LocalDate.now(terminatorOriginalJudgementDay); // FIXME
//        fail("Delete this fail() and FIX the assertion line below.");
    ...
    public void simpleAssignmentOfLocalTime() {
        ...
        //-----------------------------------------
         LocalTime sevenFiftyTwoAm = LocalTime.of(07, 52); //FIXME
//        fail("Delete this fail() and FIX the assertion line below.");
    ...
    public void recommendedDateBasedTestingForLocalTime() {
        ...
        // REPLACE the now() with the the right value.
        //-----------------------------------------
         LocalTime tOJDTime = LocalTime.now(terminatorOriginalJudgementDay);
...
//        fail("Delete this fail() and FIX the assertion lines below.");
    ...
    public void recommendedDateBasedTestingForZonedDateTime() {
        ...
        //-----------------------------------------
//        fail("Delete this fail() and FIX the assertion lines below.");
         assertEquals("The expected and actual values need to match", 8, gmtPlusOneHourTimeForTOJD.getMonthValue());
         assertEquals("The expected and actual values need to match", 3, gmtPlusOneHourTimeForTOJD.getHour());
         assertEquals("The expected and actual values need to match", 14, gmtPlusOneHourTimeForTOJD.getMinute());
    }
