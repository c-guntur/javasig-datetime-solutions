...
//        fail("Delete this fail() and FIX assert below.");
        assertEquals("The Month enumeration should match August.", Month.AUGUST, tOJDateTime.getMonth());
    }
...
//        fail("Delete this fail() and FIX assertions below.");
        assertEquals("The month enumeration should match August.", Month.AUGUST, monthDay.getMonth());
        assertEquals("The month value should match 8.", 8, monthDay.getMonthValue());
        assertEquals("The date value should match 29.", 29, monthDay.getDayOfMonth());
    }
...
//        fail("Delete this fail() and FIX assertion below.");
        assertEquals("The year value should match 1997.", 1997, year.getValue());
    }
    ...
    public void yearMonth() {
        ...
        // TODO: Fix assertions.
//        fail("Delete this fail() and FIX assertions below.");
        assertEquals("The month enumeration should match August.", Month.AUGUST, yearMonth.getMonth());
        assertEquals("The month value should match 8.", 8, yearMonth.getMonthValue());
        assertEquals("The year value should match 1997.", 1997, yearMonth.getYear());
    }
    ...
    public void dayOfWeek() {
        ...
        // TODO: Fix assertions.
//        fail("Delete this fail() and FIX assertion below.");
        assertEquals("The day of the week enumeration should match Friday.", DayOfWeek.FRIDAY, dayOfWeek);
    }
